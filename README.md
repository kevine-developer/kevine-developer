...
[![Portfolio](https://img.shields.io/badge/Portfolio-000000?style=for-the-badge&logo=About.me&logoColor=white)](https://kevine-portfolio.vercel.app/)
...
const kevine = {
    ...
    passion: ["Performance", "Éco-conception", "UX"],
    philosophy: "Moins de ressources, plus de valeur",
    focus: "Applications web durables et performantes"
};
```

Développeur passionné par la création d'applications web **performantes** et **durables**. Je combine excellence technique et responsabilité écologique pour concevoir des solutions modernes qui minimisent leur empreinte environnementale tout en maximisant leur impact.
...
| **Évolutif** | Sans dette technique, pensé pour durer |
